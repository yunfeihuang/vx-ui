<template>
  <page>
    <x-nav slot="header" back="/" title="Popup"></x-nav>
    <x-body slot="body">
      <group>
        <cell :arrow="false">
    ...
    <popup direction="center" :open.sync="openCenter" show-close>
    ...
    <popup :open.sync="openFull" full show-close>
      <div style="padding:0.5rem 0;">
        <group>
          <cell :arrow="false">
    ...
    <popup :open.sync="openFullTitle" full title="title" direction="right">
